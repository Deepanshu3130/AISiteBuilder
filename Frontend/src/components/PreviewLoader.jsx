...
const PreviewLoader = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-gray-950 text-white relative overflow-hidden">
      ...
      {/* background glow */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-fuchsia-500/10 blur-3xl animate-pulse"></div>
      ...
      <div className="relative z-10 w-32 h-32 flex items-center justify-center">
        ...
        <Icon className="w-8 h-8 opacity-80 animate-bounce" />
      ...
      <p
        key={current}
        className="mt-8 text-lg font-light text-white/90 tracking-wide transition-all duration-700"
      >
        {steps[current].label}
      </p>
